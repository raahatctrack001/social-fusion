...
import { createBook, getAllPublishedBooks, getBook, getBooksOfUser, getPublishedBookOfAuthor, publishBook, updateBook } from '../Controllers/book.controller.js';
...
router.route('/published-books').get(isUserLoggedIn, getAllPublishedBooks);
