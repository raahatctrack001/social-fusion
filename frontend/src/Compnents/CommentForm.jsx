...
const CommentForm = ({placeholder, buttonText, keepX, error, commentContent, setShowCommentForm, setCommentContent, handleCommentSubmit }) => {
    ...
    return (
        <form onSubmit={handleCommentSubmit} className="w-full mx-auto p-4 dark:bg-[rgb(16,23,42)] border rounded-lg shadow-md">
            ...
            {error && <Alert color={'failure'} className='h-10 mb-2 flex justify-center font-semibold'> {error} </Alert>}
            <div className="mb-4">
                <textarea
