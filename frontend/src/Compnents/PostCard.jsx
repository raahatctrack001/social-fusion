...
const PostCard = ({ post }) => {
  ...
  return (   
      <div className=' w-full flex flex-col p-2 rounded-lg object-contain cursor-pointer ' onClick={()=>navigate(`/posts/post/${post?._id}`)} >
        ...
        <hr className='mt-2'/>
        <img className='max-h-52 w-full flex justify-center items-center' src={post?.imagesURLs[0]?.url || (post?.thumbnail?.length > 0 && post.thumbnail.at(-1)) || "https://images.squarespace-cdn.com/content/v1/57263bf8f8baf385ff61bb09/1535668320137-NZQPOXCGLFT34I9E4Z1E/Screen+Shot+2018-08-30+at+6.17.10+PM.png"} alt="" />
        <div>
