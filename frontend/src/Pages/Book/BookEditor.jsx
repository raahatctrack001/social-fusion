  ...
  return (
    ...
    {thumbnailURL && <div className='flex justify-center items-center overflow-scroll mt-2 w-full'>
      ...
      <div className='m-5 min-h-screen'>
          ...
          <div className=''>
            ...
            {showInstructions && <div className="p-4 bg-blue-100 border border-blue-300 rounded-lg mb-1">
              <div className='flex justify-between'>
                <h2 className="text-lg font-semibold text-blue-800 mb-2">Add Images to enhance user engagement.</h2> 
              ...
              <p className="text-blue-700 mt-2">This will embed the image into your content. Happy Book Writing!</p>
            </div>}
          ...
          <Button onClick={handlePostUpload} color={"primary"} className='w-full my-2 border-2 hover:bg-gray-500'> Save Draft </Button>
      </div>
    </div>
  );
};
